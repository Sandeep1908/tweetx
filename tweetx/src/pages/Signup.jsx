      ...
      <div className="max-w-7xl h-full m-auto flex justify-center items-center">
        ...
        <div className="w-full h-full flex flex-col  justify-around p-10 space-y-28 ">
          ...
          <div className="flex flex-col justify-center items-start space-y-5">
            ...
            <button  className={`border-slate-400 border pr-16 pl-16 p-3 rounded-lg`}>Login</button>
          </div>
            ...
            <div className="w-full h-full flex flex-col space-y-24">
                  ...
                  <div className="max-w-96 flex flex-col space-y-5 items-start">
                      <div className="w-full">
                        <input type="text" placeholder="Name" className="bg-[#F9F9F9] p-5 rounded-md w-full outline-none "/>
                      </div>
                      ...
                      <div className="w-full">
                        <input type="text" placeholder="Confirm Password" className="bg-[#F9F9F9] p-5 rounded-md w-full outline-none "/>
                      </div>

                      <div className="w-full flex justify-end">
                      <button   className={` pr-10 pl-10 p-3 rounded-lg text-white bg-[#FF758E]`}>Sign Up</button>
                      </div>
                  </div>
            </div>
